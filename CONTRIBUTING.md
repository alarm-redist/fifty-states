...
1. Setting up:
    1. Fork the repository, or create a branch named for your analysis (e.g. `WA_cd_2020`). For the state legislature project, do not include "leg" in the name of your branch or fork.
