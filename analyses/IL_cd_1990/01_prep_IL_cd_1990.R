###############################################################################
# Download and prepare data for `IL_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg IL_cd_1990}")

path_data <- download_redistricting_file("IL", "data-raw/IL", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/IL_1990/shp_vtd.rds"
perim_path <- "data-out/IL_1990/perim.rds"
