###############################################################################
# Download and prepare data for `WA_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg WA_cd_1990}")

path_data <- download_redistricting_file("WA", "data-raw/WA", year = 1990)
...
shp_path <- "data-out/WA_1990/shp_vtd.rds"
perim_path <- "data-out/WA_1990/perim.rds"
