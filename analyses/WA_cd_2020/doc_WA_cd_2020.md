# 2020 Washington Congressional Districts
...
## Simulation Notes
We sample 32,000 districting plans for Washington across two runs of 16,000 each using the SMC algorithm, then filter down to 5,000 total plans.
