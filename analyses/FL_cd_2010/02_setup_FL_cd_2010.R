...
clust_south <- stringr::str_sub(sapply(clust_south, function(x) {tigris::lookup_code("FL", x)}), -5, -3)
...
clust_central <- stringr::str_sub(sapply(clust_central, function(x) {tigris::lookup_code("FL", x)}), -5, -3)
