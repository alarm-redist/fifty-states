#############################################################################
# Download and prepare data for `TN_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg TN_cd_1990}")

path_data <- download_redistricting_file("TN", "data-raw/TN", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/TN_1990/shp_vtd.rds"
perim_path <- "data-out/TN_1990/perim.rds"
