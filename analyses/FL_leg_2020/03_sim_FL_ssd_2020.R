...
map_shd <- read_rds("data-out/FL_2020/FL_leg_2020_map_ssd.rds")
...
constr <- redist_constr(map_ssd) |>
  ...
  add_constr_grp_hinge(8, cvap_black, cvap, 0.4) |>
  add_constr_grp_inv_hinge(-10, cvap_black, vap, 0.1) |>
  add_constr_grp_hinge(8, cvap_hisp, cvap, 0.4) |>
  add_constr_grp_inv_hinge(-10, cvap_hisp, cvap, 0.1)
