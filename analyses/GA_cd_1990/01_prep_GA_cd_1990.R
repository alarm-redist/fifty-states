###############################################################################
# Download and prepare data for `GA_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg GA_cd_1990}")

path_data <- download_redistricting_file("GA", "data-raw/GA", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/GA_1990/shp_vtd.rds"
perim_path <- "data-out/GA_1990/perim.rds"
