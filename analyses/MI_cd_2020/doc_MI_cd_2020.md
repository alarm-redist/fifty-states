...
## Simulation Notes
We sample 384,000 districting plans for Michigan across four independent runs of 96,000 each using the SMC algorithm, then filter down to 5,000 total plans.
