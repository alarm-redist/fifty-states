...
if (interactive()) {
  ...
  # If DE lacks CVAP/partisan columns, comment this block out or add them in prep.
  psum <- plans %>%
    dplyr::group_by(draw) %>%
    dplyr::summarise(
  ...
  # optional save like their PR
  ggsave("data-out/DE_2020/DE_shd_2020_HCVAP_summary.png",
