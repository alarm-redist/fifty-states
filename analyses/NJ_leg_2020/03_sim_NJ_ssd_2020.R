###############################################################################
# Simulate plans for `NJ_ssd_2020` SSD
# © ALARM Project, January 2026
###############################################################################

# Run the simulation -----
cli_process_start("Running simulations for {.pkg NJ_ssd_2020}")
...
write_rds(plans, here("data-out/NJ_2020/NJ_ssd_2020_plans.rds"), compress = "xz")
write_rds(plans, here("data-out/NJ_2020/NJ_shd_2020_plans.rds"), compress = "xz")
cli_process_done()

# Compute summary statistics -----
cli_process_start("Computing summary statistics for {.pkg NJ_ssd_2020}")
...
save_summary_stats(plans, "data-out/NJ_2020/NJ_ssd_2020_stats.csv")
