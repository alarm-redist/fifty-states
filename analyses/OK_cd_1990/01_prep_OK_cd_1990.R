###############################################################################
# Download and prepare data for `OK_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg OK_cd_1990}")

path_data <- download_redistricting_file("OK", "data-raw/OK", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/OK_1990/shp_vtd.rds"
perim_path <- "data-out/OK_1990/perim.rds"
