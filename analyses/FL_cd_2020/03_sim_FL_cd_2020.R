...
#NEXT STEPS:
#1. Figure out best constraint strengths, especially given that we have only 1 Black MMD
#2. Figure out best way to explain all of this
...
plans_south <- redist_smc(map_south, counties = pseudo_county,
...
fl_plan_list <- list(list(map = map_south, plans = plans_south[plans_south$draw != "cd_2020",]),
