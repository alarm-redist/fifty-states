...
## Simulation Notes
We sample 104,000 districting plans for Washington across eight runs of 13,000 each using the SMC algorithm and thinned the samples down to 5,000. To comply with the federal VRA and to respect communities of interest, we add a weak VRA constraint targeting one majority-minority district (currently WA-09).
