###############################################################################
# Download and prepare data for `IN_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg IN_cd_1990}")

path_data <- download_redistricting_file("IN", "data-raw/IN", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/IN_1990/shp_vtd.rds"
perim_path <- "data-out/IN_1990/perim.rds"
