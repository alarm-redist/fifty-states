###############################################################################
# Simulate plans for `IN_ssd_2020` SSD
...
mh_accept_per_smc <- ceiling(n_distinct(map_ssd$ssd_2020)/3) + 25
...
write_rds(plans, here("data-out/IN_2020/IN_ssd_2020_plans.rds"), compress = "xz")
cli_process_done()
