...
## Simulation Notes
We sample 12,000 districting plans across two independent runs of 6,000 each using the SMC algorithm. We set the population tempering at 0.05 to avoid bottlenecks. We then remove all plans that do not contain any district that has both a BVAP of over 30% and an average voteshare that is more Democratic than Republican. This remove occurs after verifying that such plans comprise less than 1% of the 12,000 plans. We then thin the sample down to exactly 5,000 plans.
