...
if (interactive()) {
  ...
  dir.create(here("data-out/AL_2020/bvap_plots"), showWarnings = FALSE, recursive = TRUE)
  ...
  ggsave(here("data-out/AL_2020/bvap_plots/bvap_performance.png"), p1, width = 10, height = 6)
  ...
  print(tbl1)
  write_csv(tbl1, here("data-out/AL_2020/bvap_plots/dem_seats_by_bvap_rank.csv"))
  ...
  print(tbl2)
  write_csv(tbl2, here("data-out/AL_2020/bvap_plots/total_black_performant.csv"))
}
