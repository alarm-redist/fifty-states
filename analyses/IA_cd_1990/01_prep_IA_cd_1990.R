###############################################################################
# Download and prepare data for `IA_cd_1990` analysis
...
cli_process_start("Downloading files for {.pkg IA_cd_1990}")

path_data <- download_redistricting_file("IA", "data-raw/IA", year = 1990)

cli_process_done()

# Compile raw data into a final shapefile for analysis -----
shp_path <- "data-out/IA_1990/shp_vtd.rds"
