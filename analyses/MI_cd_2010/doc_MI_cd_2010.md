...
## Simulation Notes
We sample 256,000 districting plans for Michigan across four independent runs of 64,000 each using the SMC algorithm and then thinned our results to 5,000 simulations.
